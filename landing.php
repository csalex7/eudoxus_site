    ...
    <div class="col-lg-4 col-md-3 mb-3 zoom">
      <a href="/secretary" >
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-text">ΜΕΛΟΣ ΤΗΣ ΓΡΑΜΜΑΤΕΙΑΣ</p>
          </div>
        </div>
      </a>
    </div>
     ...
     <div class="col-lg-4 col-md-3 mb-3 zoom">
      <a href="/point" >
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-text">ΣΗΜΕΙΟ ΔΙΑΝΟΜΗΣ</p>
          </div>
        </div>
      </a>
    </div>
    ...
    <div class="col-lg-4 col-md-3 mb-3 zoom">
      <a href="/provider" >
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-text">ΔΙΑΘΕΤΗΣ ΔΩΡΕΑΝ ΣΥΓΓΡΑΜΜΑΤΩΝ</p>
          </div>
        </div>
      </a>
    </div>
